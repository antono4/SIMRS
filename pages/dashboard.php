  ...
  <div class="col-lg-4">
    <div class="card text-bg-primary mb-4">
      ...
      <div class="card-body">
        ...
        <hr />
        <p class="mb-0 small">Database: <code>sik</code> (<?= number_format((int)db_val("SELECT COUNT(*) FROM information_schema.tables WHERE table_schema='sik'")) ?> tabel, kompatibel SIMRS Khanza)</p>
      </div>
    </div>
  </div>
</div>
